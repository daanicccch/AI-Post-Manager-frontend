      ...
      <section className="queue-control-card queue-control-card--profile">
        <div className="queue-control-card__top">
          <div className="queue-control-card__title">
            <h2>{isRu ? '\u0428\u0430\u0433 4. \u041f\u043b\u0430\u043d \u043f\u0443\u0431\u043b\u0438\u043a\u0430\u0446\u0438\u0439' : 'Step 4. Planner'}</h2>
          </div>
        </div>
        <div className="setup-stepbar" aria-label="Onboarding steps">
          ...
          <span className="setup-stepbar__item setup-stepbar__item--done">{isRu ? '\u041f\u0440\u043e\u0441\u043c\u043e\u0442\u0440' : 'Review'}</span>
          <span className="setup-stepbar__item setup-stepbar__item--active">{isRu ? '\u041f\u043b\u0430\u043d' : 'Plan'}</span>
        </div>
